...
brew install caskroom/cask/brew-cask openssl subversion libxml2 json-c
...
brew install ack cvs heroku-toolbelt json-c libyaml memcached mercurial mysql postgresql redis riak v8 uncrustify
brew cask install android-studio ax88179 dropbox firefox gimp google-chrome google-drive google-earth google-earth-web-plugin google-hangouts inkscape hipchat iterm2 psequel skype slack steam sublime-text3 tunnelblick vlc
