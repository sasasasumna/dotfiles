...
# for install Brew: ruby -e "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/reinstall/master/install)"
...
brew reinstall yasm --with-python
brew reinstall gd --with-libvpx # has issue with El Capitan
...
brew reinstall erlang --with-fop --with-native-libs
brew reinstall nginx --with-gunzip --with-spdy --with-webdav

brew reinstall ack cvs heroku-toolbelt json-c libyaml memcached mercurial mysql redis riak rbenv ruby-build rust elixir homebrew/versions/v8-315
brew cask reinstall java android-studio ax88179 dropbox firefox gimp google-chrome google-drive google-earth google-earth-web-plugin google-hangouts inkscape hipchat iterm2 psequel skype slack steam sublime-text3 tunnelblick vagrant vagrant-manager virtualbox visual-studio-code vlc
